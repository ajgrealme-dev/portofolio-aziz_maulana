  ...
  return (
    <section 
      ...
      style={{ 
        ...
        zIndex: 3, 
        background: isDark 
          ? 'linear-gradient(180deg, rgba(7, 10, 25, 0.96) 0%, rgba(5, 5, 15, 0.98) 100%)' 
          : 'linear-gradient(180deg, rgba(235, 242, 255, 0.96) 0%, rgba(245, 240, 255, 0.98) 100%)', 
        backdropFilter: 'blur(20px)', 
        WebkitBackdropFilter: 'blur(20px)', 
        borderTop: isDark ? '1px solid rgba(57, 255, 20, 0.15)' : '1px solid rgba(139, 92, 246, 0.15)', 
